...
const columns = [
  ...
  {field:"img",headerName:"Profil",renderCell:(params)=>{
    return <div><img src= {params.row.url_image} className='cover rounded-full w-10 h-10 border border-green-300 border-2 cursor-pointer' style = {{boxShadow:"4px 4px  1px rgba(0,0,0,0.1)"}}/></div>
  }},
  {
    field: 'fullname',
    headerName: 'Nom',
