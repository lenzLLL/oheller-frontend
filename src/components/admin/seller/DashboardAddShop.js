...
export default function DashboardAddShop() {
  ...
  const saveShop = async () => {
    try{
        ...
        if(response.status === 201)
        {
          ...
          Swal.fire(
            'Boutique Créé',
            'Votre boutique a été Créé avec success',
            'success'
          )  
        }
      }
    ...
    return (
        <div className='dashboarshop' >
                   ...
                   <h1 className='text-3xl text-gray-900 mb-5'>Créer une boutique</h1>
       <h3 className='text-xl text-gray-900 mb-5'>Entrez les informations de votre boutique</h3>
       ...
       { disponibilite.map((option) => (
         ...
         {option}
           ...
           <button disabled = {isLoading} onClick={saveShop}  className='flex cursor-pointer gap-1 outline-none items-center justify-center border w-[300px] py-[13px] hover:shadow-lg px-20 bg-purple-500 text-white rounded-lg shadow-sm'>
