...
export default function DashboarUpdateAddSondage() {
  ...
  const goToNext = () =>{
    ...
    else if(data.participants>verifySondage().length)
    {
      ...
      return 
        ...
        localStorage.setItem("sondage1-update",JSON.stringify(data))
        localStorage.removeItem("questions-update")
  ...
  const professions = [
   ...
   const handleReset = () => {
    ...
    return (
       ...
       <h3 className='text-2xl text-gray-900 mb-5 text-center mt-10'>Modifiez votre sondage avant son lancement</h3>
