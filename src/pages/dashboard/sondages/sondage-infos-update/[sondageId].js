...
import DashboarUpdateAddSondage from '@/components/admin/sondages/DashboardUpdateAddSondage'
...
import DashboardAdminSondageInfos from '@/components/admin/sondages/DashboardAdminSondageInfos'
export default function index() {
  ...
  return (
    <div className='main min-h-screen bg-[#2a3445]'>
        ...
        { data.accountType !== "Admin" && < DashboarUpdateAddSondage />}
        {data.accountType === "Admin" && <DashboardAdminSondageInfos/>}
            </div> 
        </div>
        <Footer/>
    </div>
