...
import DashboardSondagePayment from '@/components/admin/sondages/DashboardSondagePayment'
import DashboardAdminSondagePayment from '@/components/admin/sondages/DashboardAdminSondagePayment'
  ...
  return (
    <div className='main min-h-screen bg-[#2a3445]'>
        ...
        <div className='containe flex'>
         ...
         {data.accountType !== "Admin" && <DashboardSondagePayment/>}
     {data.accountType === "Admin" && <DashboardAdminSondagePayment/>}
            </div> 
        </div>
        <Footer/>
    </div>
