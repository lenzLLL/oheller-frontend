...
import DashboardMessages from '@/components/admin/seller/messages/DashboardMessages'
import DashboardCity from '@/components/admin/villes/DashboardCity'
import DashboardProfession from '@/components/admin/profession/DashboardProfesssion'
    ...
    <div className='main min-h-screen bg-[#2a3445]'>
        ...
        <div className='containe flex'>
            <div className='menuContainer w-[250px] py-[5px] px-[20px]  border-r-[2px] border-r-[#384256]'>
                <Menu data = {data} current = {"/dashboard/admin/profession"}/>
            </div>
