...
import DashboardProductsOrders from '@/components/admin/seller/orders/DashboardProductsOrders'
...
import DashboardSingleOrder from '@/components/admin/seller/orders/DashboardSingleOrder'
import DashboardSingleServiceOrder from '@/components/admin/freelancer/orders/DashboardSingleServiceOrder'
    ...
    <div className='main min-h-screen bg-[#2a3445]'>
        ...
        <div className='containe flex'>
            <div className='menuContainer w-[250px] py-[5px] px-[20px]  border-r-[2px] border-r-[#384256]'>
                <Menu data = {data} current = {"/dashboard/freelancer/orders"}/>
            </div>
            <div className='menuContainer py-[5px] px-[20px] w-[100%]'>
                <DashboardSingleServiceOrder/>
            </div> 
        </div>
        <Footer/>
    </div>
